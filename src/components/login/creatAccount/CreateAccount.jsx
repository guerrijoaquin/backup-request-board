    ...
    const nextStep = () => {
        ...
        if (active === 3) {
            ...
            if (isUsernameValid) {
                ...
                if (!isUsernameValid) {
                    setUsernameError('El nombre de usuario no debe contener caracteres especiales ni espacios.');
                } else {
                    setUsernameError('');
                }
            }
        ...
        <Center>
            <Container size={700} my={50}>
                <Stepper active={active} onStepClick={setActive} breakpoint="sm">
                    ...
                    <Stepper.Step label="Segundo paso" description="Verificar correo electrónico">
                        <Container size={400} my={50}>
                            <TextInput label="Email" value={email} readOnly />
                            <TextInput label="Código de confirmación" placeholder="Ingresa el código" required />
                        </Container>
                    </Stepper.Step>
                    <Stepper.Step label="Paso final" description="Obtener acceso completo">
                        <Container size={400} my={50}>
                            <TextInput
                    ...
                    <Stepper.Completed>
                        <Container size={600} my={50}>
                            <Container size={600} my={50}>
                                ...
                                <p>O clic en <strong>Finalizar</strong> para ir al login.</p>
                            </Container>
                        </Container>
                    </Stepper.Completed>
                </Stepper>
